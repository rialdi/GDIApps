...
namespace GDIApps.ServiceModel
{
    ...
    public class EmployeeQuery:QueryData<EmployeePOCO>
    {
        public string Id { get; set; }
        public List<string> Ids { get; set; }
        public List<string> ODataParams { get; set; }
    }
    public class EmployeePOCO : IHasId<string>
    {
