<template>
  <!-- Hero --> 
  <BasePageHeading title="Client Contra Data" subtitle="This Client Contract Data">
    <template #extra>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item" aria-current="page">Client Contract</li>
        </ol>
      </nav>
    </template>
  </BasePageHeading>
  ...
  <div class="content">
    ...
    <BaseBlock title="Result data" btn-option-fullscreen btn-option-content> 
      <!-- Main Data Grid --> 
      <CContractGrid ref="mainGridtRef"
...
import CContractGrid from "./CContractGrid.vue"

const mainGridtRef = ref<InstanceType<typeof CContractGrid>>()
